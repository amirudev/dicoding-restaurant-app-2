...
console.log(`You're running on Development mode or your browser isn't supported caching, caches are deleted and disabled`);
console.log(`Browser Caching Support: ${browserCachingSupport}`);